...
$(".btn").click(function() {
     if ($("#formCheck-2").is(':checked')) {
      $(".module2").html("Thermal Reactor Module");
      $(".m2price").html("&#9875;450");
      m2=1;
              }
}); 
...
$(".btn").click(function() {
  if(n1==1){
    $(".module11").html("Depth Module MK1");
      $(".m11price").html("&#9875;400");
  }
});   
$(".btn").click(function() {
  if(n2==1){
      $(".module12").html("Thermal Reactor Module");
      $(".m12price").html("&#9875;450");
  }
});   
$(".btn").click(function() {
  if(n3==1){
      $(".module13").html("Sonar Module");
      $(".m13price").html("&#9875;600");
  }
});