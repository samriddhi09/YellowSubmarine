...
$(".btn").click(function() {
 ...
 $(".btn").click(function() {
     if ($("#formCheck-3").is(':checked')) {
      $(".module3").html("Fire Suppression System");
      $(".m3price").html("&#9875;600000");
      m3=1;
              }
});
...
$(".btn").click(function() {
  if(n1==1){
    $(".module11").html("Storage");
      $(".m11price").html("&#9875;400000");
  }
});   
$(".btn").click(function() {
  if(n2==1){
      $(".module12").html("Extra Boosters");
      $(".m12price").html("&#9875;100000");
  }
});   
$(".btn").click(function() {
  if(n3==1){
      $(".module13").html("Fire Suppression System");
      $(".m13price").html("&#9875;600000");
  }
});