...
$(".btn").click(function() {
     if ($("#formCheck-2").is(':checked')) {
      $(".module2").html("Energy Efficiency module");
      $(".m2price").html("&#9875;400");
      m2=1;
              }
}); 
...
$(".btn").click(function() {
  if(n1==1){
    $(".module11").html("Solar Charger");
      $(".m11price").html("&#9875;350");
  }
});   
$(".btn").click(function() {
  if(n2==1){
      $(".module12").html("Energy Efficiency module");
      $(".m12price").html("&#9875;400");
  }
});   
$(".btn").click(function() {
  if(n3==1){
      $(".module13").html("Glass tints");
      $(".m13price").html("&#9875;50");
  }
});